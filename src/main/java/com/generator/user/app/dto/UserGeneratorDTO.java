...
public class UserGeneratorDTO implements Serializable {
   ...
   public UserGeneratorDTO() {
      // Default constructor
   }

   public UserGeneratorDTO(String firstName, String lastName, Date birthDate, String city, String country, String avatar, String company, String jobPosition, String mobile, String username, String email, String password, String role) {
   ...
   public void setPassword(String password) {
      if (password.length() >= 6 && password.length() <= 10) {
         ...
         throw new IllegalArgumentException("Password must be between 6 and 10 characters long.");
      }
   }
